...
1. For `Amazon S3 URL`, copy the link to the latest version of the template e.g. "https://superwerker-release.s3.amazonaws.com/1.3.0/templates/superwerker.template.yaml", the latest version number can be found here: [Github Releases](https://github.com/superwerker/superwerker/releases)
1. Click `Next`
1. Click `Next`
1. Click `Next` again
