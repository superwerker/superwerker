...
do
    ...
    SUPERWERKER_REGION=eu-east-1 SOURCE_PROFILE=superwerker-test1-master AWS_ACCOUNT_ID=${stale} CAPTCHA_API_KEY=02432dfb3dd64998a683bc797d1b94f5 ./terminate-test-env.sh ||
    echo "skipping"
done