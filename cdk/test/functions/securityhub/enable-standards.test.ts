...
describe('enableStandards', () => {
  ...
  it('fail first control retrival', async () => {
    const enableMissingStandard = [
      {
        name: 'AWS Foundational Security Best Practices v1.0.0',
        enable: true,
    ...
    securityHubClientMock
      .on(DescribeStandardsControlsCommand)
      .resolvesOnce({
        Controls: [],
        NextToken: undefined,
      })
...
// securityHubClientMock.on(DescribeStandardsControlsCommand).resolvesOnce({
//   Controls: [
//     {
//       StandardsControlArn: 'arn:aws:securityhub:eu-central-1:612346150483:control/aws-foundational-security-best-practices/v/1.0.0/ACM.1',
//       ControlStatus: 'ENABLED',
//       ControlId: 'ACM.1',
//     },
//   ],
...
// securityHubClientMock.on(GetEnabledStandardsCommand).resolvesOnce({
//   StandardsSubscriptions: [
//     {
//       StandardsSubscriptionArn:
//         'arn:aws:securityhub:eu-central-1:11223344556677:subscription/aws-foundational-security-best-practices/v/1.0.0',
//       StandardsArn: secHubStandards[0].StandardsArn,
//       StandardsInput: {},
//       StandardsStatus: StandardsStatus.READY,
//     },
//   ],
//   NextToken: undefined,
// });
...
//     {
//       StandardsControlArn:
//         'arn:aws:securityhub:eu-central-1:11223344556677:control/aws-foundational-security-best-practices/v/1.0.0/CloudFormation.1',
//       ControlStatus: 'ENABLED',
//     },
//   ],
//   NextToken: undefined,
