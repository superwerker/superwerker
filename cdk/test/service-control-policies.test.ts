...
import { ServiceControlPoliciesStack } from '../src/stacks/sevice-control-policies';

export class UnderTestStack extends Stack {
  public readonly inner: Stack;
  constructor(scope: Construct, id: string, props: StackProps) {
    super(scope, id, props);
    this.inner = new ServiceControlPoliciesStack(this, 'stack', {});
  }
}
...
export class OriginalStack extends Stack {
  constructor(scope: Construct, id: string, props: StackProps) {
    super(scope, id, props);
    new CfnInclude(this, 'SCPTemplate', {
