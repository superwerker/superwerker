...
**DISCLAIMER**: The Controltower version in the script is fixed to **version 3.3**. Please make sure to update your Controltower to version 3.3 first before running below script. You can update it in the landingzone settings [here](https://console.aws.amazon.com/controltower/home/settings)
